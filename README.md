...
# Index
- [Project Overview](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#project-overview)
- [Project Setup Instructions](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#project-setup-instructions)
- [Key Benefits](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#key-benefits)
- [System Integration and Architecture](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#system-integration-and-architecture)
- [Software](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#software)
- [Software Setup Instructions](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#software-setup-instructions)
- [Hardware](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#hardware)
- [Hardware Setup Instructions](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#hardware-setup-instructions)
- [Why We Chose the I2C / Stemma QT Ecosystem](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#why-we-chose-the-i2c--stemma-qt-ecosystem)
- [Network](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#network-1)
- [Network Setup Instructions](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#network-setup-instructions)
- [Error Handling and Logging](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#error-handling-and-logging)
- [Troubleshooting](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#troubleshooting)
- [Maintenance](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#maintenance)
- [Race Event Management and Timing System](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#race-event-management-and-timing-system)
- [API Endpoints (Central Server)](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#api-endpoints-central-server)
- [WebSocket Events](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#websocket-events)
- [Future Enhancements](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#future-enhancements)
- [License](https://github.com/antoinesylvia/Texas_Heat_Raceway/tree/main?tab=readme-ov-file#license)
...
- Phase 5: Inclusion of mechanical efficiency  coefficient of friction, energy transfer efficiency, energy conversion efficiency, impulse & momentum change. [Planned]
...
5. Implementation of formulas for phase 2, 3, 4, and 5: Requires an additional checkpoint gate (at the end of an incline). [##Formulas##](https://github.com/antoinesylvia/Texas_Heat_Raceway/blob/main/FORMULAS_TEXAS_HEAT_RACEWAY.md):
6. Docker
7. Drag Race Slips
