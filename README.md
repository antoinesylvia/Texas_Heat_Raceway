...
- Phase 1: Focused on time, speed and distance (measured). [Currently Testing]
- Phase 2: Focus will be on Gravitational Acceleration (incline drop) and Linear Acceleration (straightaway between checkpoint and finish gate). [Planned]
- Phase 3: Focus will be on Potential Energy, Work Done, ForcePower, Force and G-Force. [Planned]
- Phase 4: Focus will be on Energy Efficiency, Coefficient of Restitution, Heat Generation, Impulse & Jerk, and Terminal Velocity. [Planned]
