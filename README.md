...
- Phase 1 we are focused on time, speed and distance (measured). [Currently Testing]
- Phase 2 we will focus on Gravitational Acceleration (incline drop) and Linear Acceleration (straightaway between checkpoint and finish gate). [Planned]
- Phase 3 we will focus on Potential Energy, Work Done, ForcePower, Force and G-Force. [Planned]
- Phase 4 we will focus on Energy Efficiency, Coefficient of Restitution, Heat Generation, Impulse & Jerk, and Terminal Velocity. [Planned]
